...
LRESULT CALLBACK WndProc(HWND hwnd,UINT message,WPARAM wParam,LPARAM lParam){
    ...
    switch(message){
        ...
        case WM_PAINT:
            ...
            drawEllipse(295, 200, 100, 70);
             drawEllipse(295, 200, 10, 70);

            drawLineDDA(394,131,394,271);
            drawLineDDA(394,271,196,271);

            drawLineDDA(196,271,195,131);

            drawLineDDA(195,131,394,131);
